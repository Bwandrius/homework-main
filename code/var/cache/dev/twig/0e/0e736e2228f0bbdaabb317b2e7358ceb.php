...
class __TwigTemplate_44c15d065e29987180cd226e8a4449f0 extends Template
{
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        echo "</h1>
                    <p class=\"text-muted\">";
        // line 9
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 9, $this->source); })()), "readingTime", [], "any", false, false, false, 9), "html", null, true);
        echo "</p>
                </div>
        ...
        <div class=\"py-5 bg-light\">
            <div class=\"container\">
                <div class=\"py-5 text-center\">
                    ...
                    <p class=\"text-muted\">{{ article.readingTime }}</p>
                </div>
